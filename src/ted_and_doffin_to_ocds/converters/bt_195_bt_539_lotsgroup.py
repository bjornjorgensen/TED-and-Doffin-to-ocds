...
def parse_bt195_bt539_lotsgroup_unpublished_identifier(xml_content):
    """
    Parse the XML content to extract the unpublished identifier for the award criterion type in LotsGroup.
