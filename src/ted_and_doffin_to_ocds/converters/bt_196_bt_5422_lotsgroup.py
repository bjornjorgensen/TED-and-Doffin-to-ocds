...
def parse_bt196_bt5422_lotsgroup(xml_content):
    """
...
def merge_bt196_bt5422_lotsgroup(release_json, unpublished_justification_data) -> None:
    """
    ...
    if not unpublished_justification_data:
        logger.warning(
            "No unpublished justification description data to merge for BT-196(BT-5422)-LotsGroup",
        )
        return
    ...
    logger.info(
        "Merged unpublished justification description data for BT-196(BT-5422)-LotsGroup",
    )
