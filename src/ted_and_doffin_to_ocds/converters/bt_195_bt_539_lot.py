...
def parse_bt195_bt539_unpublished_identifier(xml_content):
    """
    Parse the XML content to extract the unpublished identifier for the award criterion type.
...
def merge_bt195_bt539_unpublished_identifier(release_json, unpublished_identifier_data):
    """
