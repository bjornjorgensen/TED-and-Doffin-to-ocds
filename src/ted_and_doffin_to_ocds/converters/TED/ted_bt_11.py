...
from ted_and_doffin_to_ocds.converters.eforms.bt_11_procedure_buyer import BUYER_LEGAL_TYPE_CODES, NAMESPACES

logger = logging.getLogger(__name__)

def parse_ted_buyer_legal_type(xml_content: str | bytes) -> dict[str, list[dict]] | None:
    ...
    org_id_results = root.xpath("//cac:PartyIdentification/cbc:ID[@schemeName='organization']/text()", namespaces=NAMESPACES)
