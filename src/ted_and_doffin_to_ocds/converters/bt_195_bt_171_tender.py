...
def parse_bt195_bt171_unpublished_identifier(xml_content):
    """
    Parse the XML content to extract the unpublished identifier for the tender rank.
...
def merge_bt195_bt171_unpublished_identifier(release_json, unpublished_identifier_data):
    """
