...
def parse_bt195_bt555_unpublished_identifier(xml_content):
    """
    Parse the XML content to extract the unpublished identifier for the subcontracting percentage.
...
def merge_bt195_bt555_unpublished_identifier(release_json, unpublished_identifier_data):
    """
    ...
    logger.info(
        f"Merged {len(unpublished_identifier_data['withheldInformation'])} unpublished identifier(s) for BT-195(BT-555)",
    )
