...
def parse_essential_assets(xml_content):
    ...
    for contract in settled_contracts:
        ...
        has_essential_assets = (
            extended_duration[0].lower() == "true" if extended_duration else None
        )
        ...
        lot_results = root.xpath(
            f"//efac:noticeResult/efac:LotResult[efac:SettledContract/cbc:ID[@schemeName='contract']/text()='{contract_id}']",
            namespaces=namespaces,
        )
