...
def parse_bt195_bt5421_lotsgroup(xml_content: str | bytes) -> dict | None:
    ...
    in lots groups and creates a structured dictionary containing withheld information.
...
def merge_bt195_bt5421_lotsgroup(
