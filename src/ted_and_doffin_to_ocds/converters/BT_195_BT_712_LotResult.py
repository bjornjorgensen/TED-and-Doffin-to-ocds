...
def parse_bt195_bt712_unpublished_identifier(xml_content):
    """
    Parse the XML content to extract the unpublished identifier for the buyer review complainants.
...
def merge_bt195_bt712_unpublished_identifier(release_json, unpublished_identifier_data):
    """
    ...
    logger.info(
        f"Merged {len(unpublished_identifier_data['withheldInformation'])} unpublished identifier(s) for BT-195(BT-712)",
    )
