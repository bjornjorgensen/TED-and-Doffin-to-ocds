...
def parse_bt196_bt541_lotsgroup_threshold_unpublished_justification(xml_content):
    """
...
def merge_bt196_bt541_lotsgroup_threshold_unpublished_justification(
    ...
    logger.info(
        f"Merged unpublished justification data for BT-196(BT-541) LotsGroup Threshold for {len(unpublished_justification_data['withheldInformation'])} lots groups",
    )
