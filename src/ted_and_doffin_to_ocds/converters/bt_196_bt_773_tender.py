...
def parse_bt196_bt773_tender_unpublished_justification(xml_content):
    """
    Parse the XML content to extract the unpublished justification description for the subcontracting term in lot tenders.
...
def merge_bt196_bt773_tender_unpublished_justification(
    ...
    logger.info(
        "Merged unpublished justification data for BT-196(BT-773)-Tender: %d items",
