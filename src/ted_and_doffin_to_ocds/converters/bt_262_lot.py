...
def parse_main_classification_code_lot(
    xml_content: str | bytes,
) -> dict[str, Any] | None:
    """
    Parse the XML content to extract main classification codes for each lot.

    Processes BT-262-Lot field which contains the main classification code.
        ...
        if classifications:
            ...
            if code:
                item = {
                    ...
                    "classification": {
                        "scheme": classification.get("listName", "").upper() or "CPV",
                        "id": code,
                    },
                    "relatedLot": lot_id,
                }
...
def merge_main_classification_code_lot(
