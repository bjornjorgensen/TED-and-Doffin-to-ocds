...
def parse_bt196_bt554_unpublished_justification(xml_content):
    """
...
def merge_bt196_bt554_unpublished_justification(
    ...
    if not unpublished_justification_data:
        logger.warning("No unpublished justification data to merge for BT-196(BT-554)")
        return
    ...
    logger.info(
        "Merged %d unpublished justification(s) for BT-196(BT-554)",
