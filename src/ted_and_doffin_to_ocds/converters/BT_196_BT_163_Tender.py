...
def parse_bt196_bt163_unpublished_justification(xml_content):
    """
    Parse the XML content to extract the unpublished justification description for the concession value description.
    ...
    for lot_tender in lot_tenders:
        ...
        reason_description = lot_tender.xpath(
            "efac:ConcessionRevenue/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='val-con-des']/efbc:ReasonDescription/text()",
...
def merge_bt196_bt163_unpublished_justification(
    ...
    logger.info(
        f"Merged unpublished justification data for BT-196(BT-163): {len(unpublished_justification_data['withheldInformation'])} items"
    )
