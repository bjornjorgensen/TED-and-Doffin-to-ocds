...
def parse_bt196_bt710_unpublished_justification(
    ...
    xpath_query = "/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeResult/efac:LotResult/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='ten-val-low']"
...
def merge_bt196_bt710_unpublished_justification(
    ...
    logger.info(
        "Merged unpublished justification data for BT-196(BT-710) LotResult for {} lot results",
