...
def parse_bt195_bt191_unpublished_identifier(xml_content):
    """
    Parse the XML content to extract the unpublished identifier for the country origin.
...
def merge_bt195_bt191_unpublished_identifier(release_json, unpublished_identifier_data):
    """
    ...
    logger.info(
        f"Merged unpublished identifier data for BT-195(BT-191): {len(unpublished_identifier_data['withheldInformation'])} items"
    )
