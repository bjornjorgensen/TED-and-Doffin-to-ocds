...
def parse_tool_atypical_url(xml_content):
    ...
    for lot in lots:
        ...
        if atypical_url:
            result["lots"].append(
                {"id": lot_id, "communication": {"atypicalToolUrl": atypical_url[0]}},
            )
    ...
    if part_url:
        result["tender"]["communication"] = {"atypicalToolUrl": part_url[0]}
...
def merge_tool_atypical_url(release_json, atypical_url_data):
        ...
        for new_lot in atypical_url_data["lots"]:
            ...
            if existing_lot:
                existing_lot.setdefault("communication", {})["atypicalToolUrl"] = (
                    new_lot["communication"]["atypicalToolUrl"]
                )
            else:
    ...
    if atypical_url_data.get("tender", {}).get("communication"):
        tender.setdefault("communication", {})["atypicalToolUrl"] = atypical_url_data[
            "tender"
        ]["communication"]["atypicalToolUrl"]
