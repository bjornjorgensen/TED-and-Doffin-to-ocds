...
def parse_bt195_bt759_lotresult_unpublished_identifier(xml_content):
    """
    Parse the XML content to extract the unpublished identifier for the received submissions count in lot results.
...
def merge_bt195_bt759_lotresult_unpublished_identifier(
    ...
    logger.info(
        f"Merged unpublished identifier data for BT-195(BT-759)-LotResult: {len(unpublished_identifier_data['withheldInformation'])} items",
    )
