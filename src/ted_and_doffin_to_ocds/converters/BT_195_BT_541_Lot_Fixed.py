...
def parse_bt195_bt541_lot_fixed_unpublished_identifier(xml_content):
    """
    Parse the XML content to extract the unpublished identifier for the award criterion number fixed in Lot.
...
def merge_bt195_bt541_lot_fixed_unpublished_identifier(
    ...
    logger.info(
        f"Merged unpublished identifier data for BT-195(BT-541)-Lot-Fixed: {len(unpublished_identifier_data['withheldInformation'])} items",
    )
