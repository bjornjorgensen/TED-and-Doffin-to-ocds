...
def parse_bt195_bt162_unpublished_identifier(xml_content):
    """
    Parse the XML content to extract the unpublished identifier for the concession revenue user.
    ...
    for lot_tender in lot_tenders:
        ...
        field_identifier = lot_tender.xpath(
            "efac:ConcessionRevenue/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='con-rev-use']/efbc:FieldIdentifierCode/text()",
...
def merge_bt195_bt162_unpublished_identifier(release_json, unpublished_identifier_data):
    """
    ...
    logger.info(
        f"Merged unpublished identifier data for BT-195(BT-162): {len(unpublished_identifier_data['withheldInformation'])} items"
    )
