...
def parse_bt196_bt541_lot_weight_unpublished_justification(xml_content):
    """
    Parse the XML content to extract the unpublished justification description for the lot weight.
    ...
    for lot in lots:
        ...
        reason_description = lot.xpath(
            ".//efac:AwardCriterionParameter[efbc:ParameterCode/@listName='number-weight']/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='awa-cri-num']/efbc:ReasonDescription/text()",
...
def merge_bt196_bt541_lot_weight_unpublished_justification(
    ...
    logger.info(
        "Merged unpublished justification data for BT-196(BT-541) Lot Weight for {} lots",
