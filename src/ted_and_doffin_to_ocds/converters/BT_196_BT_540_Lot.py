...
def parse_bt196_bt540_lot_unpublished_justification(xml_content):
    """
    Parse the XML content to extract the unpublished justification description for the award criterion description in Lot.
...
def merge_bt196_bt540_lot_unpublished_justification(
    ...
    logger.info(
        f"Merged unpublished justification data for BT-196(BT-540)-Lot: {len(unpublished_justification_data['withheldInformation'])} items",
    )
