...
def parse_bt195_bt733_unpublished_identifier(xml_content):
    """
    Parse the XML content to extract the unpublished identifier for the award criteria order justification.
...
def merge_bt195_bt733_unpublished_identifier(release_json, unpublished_identifier_data):
    """
