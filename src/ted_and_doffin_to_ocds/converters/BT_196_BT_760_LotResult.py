...
def parse_bt196_bt760_lotresult_unpublished_justification(xml_content):
    """
    Parse the XML content to extract the unpublished justification description for the received submissions type in lot results.
...
def merge_bt196_bt760_lotresult_unpublished_justification(
    ...
    logger.info(
        f"Merged unpublished justification data for BT-196(BT-760)-LotResult: {len(unpublished_justification_data['withheldInformation'])} items",
    )
