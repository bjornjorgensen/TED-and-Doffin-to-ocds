# converters/bt_5101c_procedure.py
...
def parse_procedure_place_performance_streetline2(
...
def merge_procedure_place_performance_streetline2(
    ...
    procedure_place_performance_streetline2_data: dict[str, Any] | None,
) -> None:
    """
    ...
    Args:
        ...
        procedure_place_performance_streetline2_data: The source data containing delivery addresses to merge
    ...
    for new_address in procedure_place_performance_streetline2_data["tender"][
        "deliveryAddresses"
    ]:
