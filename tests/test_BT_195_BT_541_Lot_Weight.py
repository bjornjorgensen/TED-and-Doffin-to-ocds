...
def test_bt_195_bt_541_unpublished_award_criterion_number_weight_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_unpublished_award_criterion_number_weight.xml"
    ...
    assert withheld_info["id"] == "awa-cri-num-weight-LOT-0001", f"Expected id 'awa-cri-num-weight-LOT-0001', got {withheld_info['id']}"
