...
def test_bt_5421_lots_group_award_criterion_number_weight_integration(
    ...
    logger.info(
        "Test bt_5421_lots_group_award_criterion_number_weight_integration passed successfully."
    )
