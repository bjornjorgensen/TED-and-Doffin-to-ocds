...
def test_bt_197_bt712_lot_result_integration(tmp_path, setup_logging):
    ...
    """
    xml_file = tmp_path / "test_input_bt197_bt712.xml"
...
def test_bt_197_bt712_lot_result_missing_field(tmp_path, setup_logging):
    logger = setup_logging
    xml_content = """
    <root xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
          xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2"
    ...
    """
    xml_file = tmp_path / "test_input_bt197_bt712_missing.xml"
    xml_file.write_text(xml_content)
