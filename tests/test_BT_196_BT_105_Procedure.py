...
def test_bt_196_bt_105_procedure_integration(tmp_path):
    ...
    assert withheld_info["rationale"] == "Information delayed publication because of ...", f"Expected rationale 'Information delayed publication because of ...', got {withheld_info['rationale']}"
