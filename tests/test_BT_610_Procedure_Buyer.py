...
def test_bt_610_procedure_buyer_integration(tmp_path):
    ...
    assert classification["scheme"] == "eu-main-activity", f"Expected scheme 'eu-main-activity', got {classification['scheme']}"
    assert classification["id"] == "gas-oil", f"Expected id 'gas-oil', got {classification['id']}"
    assert classification["description"] == "Extraction of gas or oil", f"Expected description 'Extraction of gas or oil', got {classification['description']}"
