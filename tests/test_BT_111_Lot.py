...
def test_bt_111_lot_integration(tmp_path):
    ...
    assert "frameworkAgreement" in lot_1["techniques"], "Expected 'frameworkAgreement' in LOT-0001 techniques"
    assert lot_1["techniques"]["frameworkAgreement"]["buyerCategories"] == 'Offices of the "greater region" ...', "Unexpected buyerCategories for LOT-0001"
    ...
    assert "frameworkAgreement" in lot_2["techniques"], "Expected 'frameworkAgreement' in LOT-0002 techniques"
    assert lot_2["techniques"]["frameworkAgreement"]["buyerCategories"] == "All hospitals in the Tuscany region", "Unexpected buyerCategories for LOT-0002"
