...
def test_bt_24_lot_description_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_lot_description.xml"
    ...
    assert lot["description"] == expected_description, f"Expected description '{expected_description}', got {lot['description']}"
