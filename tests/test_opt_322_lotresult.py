...
def test_parse_lotresult_technical_identifier():
    xml_content = """
...
def test_merge_lotresult_technical_identifier():
...
def test_merge_lotresult_technical_identifier_existing_award():
...
def test_merge_lotresult_technical_identifier_no_data():
    release_json = {"awards": [{"id": "RES-0001", "title": "Existing Award"}]}
