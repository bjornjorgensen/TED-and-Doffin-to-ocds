# tests/test_bt_5101c_procedure.py
...
def test_bt_5101c_procedure_integration(tmp_path, setup_logging, temp_output_dir):
    ...
    """
    xml_file = tmp_path / "test_input_procedure_place_performance_streetline2.xml"
