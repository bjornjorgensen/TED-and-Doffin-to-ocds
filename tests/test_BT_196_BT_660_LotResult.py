...
def test_bt_196_bt_660_lot_result_integration(tmp_path):
    xml_content = """
            ...
            <efac:LotResult>
                <efac:FrameworkAgreementValues>
                    <efac:FieldsPrivacy>
                        ...
                        <efbc:ReasonDescription>Information delayed publication due to sensitive financial data</efbc:ReasonDescription>
                    </efac:FieldsPrivacy>
                </efac:FrameworkAgreementValues>
            </efac:LotResult>
        </efac:NoticeResult>
    ...
    """
    xml_file = tmp_path / "test_input_bt_196_bt_660_lot_result.xml"
    ...
    expected_rationale = "Information delayed publication due to sensitive financial data"
