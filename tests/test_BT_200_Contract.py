...
def test_parse_contract_modification_reason():
    ...
    assert rationale["description"] == "Need for additional works, services or supplies by the original contractor."
...
def test_parse_contract_modification_reason_multiple_awards():
    ...
    assert rationale["description"] == "Need for modifications because of circumstances which a diligent buyer could not predict."
    assert rationale["scheme"] == "Modification justification"
