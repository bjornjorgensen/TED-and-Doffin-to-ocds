...
def test_merge_reserved_execution():
    ...
    assert release_json["tender"]["lots"][0]["contractTerms"]["reservedExecution"] == True
...
def test_bt_736_lot_reserved_execution_integration(tmp_path):
    ...
    assert "contractTerms" not in lot_2 or "reservedExecution" not in lot_2.get("contractTerms", {})
