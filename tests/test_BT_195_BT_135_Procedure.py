# tests/test_BT_195_BT_135_Procedure.py
...
def test_bt_195_bt_135_unpublished_direct_award_justification_text_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_unpublished_direct_award_justification_text.xml"
    ...
    assert withheld_info["id"] == "dir-awa-tex-18d27a53-0109-4f93-9231-6659d931bce0", f"Expected id 'dir-awa-tex-18d27a53-0109-4f93-9231-6659d931bce0', got {withheld_info['id']}"
    assert withheld_info["field"] == "dir-awa-tex", f"Expected field 'dir-awa-tex', got {withheld_info['field']}"
    assert withheld_info["name"] == "Direct Award Justification", f"Expected name 'Direct Award Justification', got {withheld_info['name']}"
