# tests/test_bt_510b_organization_company.py
...
def test_bt_510b_organization_company_integration(tmp_path, setup_logging, temp_output_dir):
    ...
    """
    xml_file = tmp_path / "test_input_organization_streetline1.xml"
