...
def test_bt_195_bt_543_unpublished_award_criteria_complicated_lot_integration(tmp_path, caplog):
    ...
    """
    xml_file = tmp_path / "test_input_unpublished_award_criteria_complicated_lot.xml"
