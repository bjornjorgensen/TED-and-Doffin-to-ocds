# tests/test_BT_196_BT_720_Tender.py
...
def test_bt_196_bt_720_tender_integration(tmp_path):
    xml_content = """
        ...
        <efac:NoticeResult>
            <efac:LotTender>
                <efac:FieldsPrivacy>
                    ...
                    <efbc:ReasonDescription>Information delayed publication due to commercial sensitivity</efbc:ReasonDescription>
                </efac:FieldsPrivacy>
            </efac:LotTender>
        </efac:NoticeResult>
    </root>
    """
    xml_file = tmp_path / "test_input_bt_196_bt_720_tender.xml"
    ...
    expected_rationale = "Information delayed publication due to commercial sensitivity"
