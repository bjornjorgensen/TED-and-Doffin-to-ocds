# tests/test_BT_196_BT_711_LotResult.py
...
def test_bt_196_bt711_lot_result_integration(tmp_path, setup_logging):
    ...
    """
    xml_file = tmp_path / "test_input_bt196_bt711.xml"
...
def test_bt_196_bt711_lot_result_missing_field(tmp_path, setup_logging):
    logger = setup_logging
    xml_content = """
    <root xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
          xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2"
