...
def test_bt_633_organization_natural_person_integration(tmp_path):
    xml_content = """
    ...
    assert party["details"]["scale"] == "selfEmployed", f"Expected scale 'selfEmployed', got {party['details']['scale']}"
