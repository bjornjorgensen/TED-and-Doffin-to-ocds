...
def test_bt_40_lot_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_lot_selection_criteria_second_stage.xml"
    ...
    assert lot["selectionCriteria"]["criteria"][0]["forReduction"] == True, "Expected 'forReduction' to be True"
