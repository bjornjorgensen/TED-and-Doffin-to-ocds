...
def test_bt_197_bt_540_lot_integration(tmp_path):
    xml_content = """
    ...
    xml_file = tmp_path / "test_input_bt_197_bt_540_lot.xml"
    ...
    bt_540_item = next((item for item in result["withheldInformation"] if item.get("field") == "BT-540"), None)
    assert bt_540_item is not None, "No withheld information item for BT-540 found"
