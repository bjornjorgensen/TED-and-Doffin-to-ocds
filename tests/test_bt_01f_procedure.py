# tests/test_bt_01f_procedure.py
...
from src.ted_and_doffin_to_ocds.converters.bt_01f_procedure import (
...
def test_bt_01f_procedure_with_local_description(setup_logging):
    ...
    # Test parsing
    parsed_data = parse_procedure_legal_basis_noid_description(xml_content)
    ...
    merge_procedure_legal_basis_noid_description(release_json, parsed_data)
...
def test_bt_01f_procedure_non_local_description():
    xml_content = """<?xml version="1.0" encoding="UTF-8"?>
    <ContractAwardNotice xmlns="urn:oasis:names:specification:ubl:schema:xsd:ContractAwardNotice-2"
              xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
              xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2">
    ...
    # Should not include non-LocalLegalBasis descriptions
    parsed_data = parse_procedure_legal_basis_noid_description(xml_content)
    assert parsed_data is None


def test_bt_01f_procedure_integration(tmp_path, setup_logging, temp_output_dir):
    logger = setup_logging
    xml_content = """<?xml version="1.0" encoding="UTF-8"?>
    <ContractAwardNotice xmlns="urn:oasis:names:specification:ubl:schema:xsd:ContractAwardNotice-2"
              xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
    ...
    """
    xml_file = tmp_path / "test_input_with_local_description.xml"
