...
def test_bt_16_touchpoint_part_name_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_touchpoint_part_name.xml"
    ...
    assert party["name"] == "Ministry of Education - Legal Department", f"Expected name 'Ministry of Education - Legal Department', got {party['name']}"
