...
def test_merge_participant_name():
    ...
    assert len(release_json["tender"]["lots"][0]["designContest"]["selectedParticipants"]) == 1
    assert release_json["tender"]["lots"][0]["designContest"]["selectedParticipants"][0]["name"] == "Mr P. Sanchez"
