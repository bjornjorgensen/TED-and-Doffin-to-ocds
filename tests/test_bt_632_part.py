...
def test_bt_632_part_integration(tmp_path, setup_logging, temp_output_dir) -> None:
    ...
    # logger.info("Test bt_632_part_integration passed successfully.") # Logging disabled
