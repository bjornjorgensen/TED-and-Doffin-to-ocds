# tests/test_bt_198_bt_1252_procedure.py
...
def test_bt_198_bt_1252_procedure_integration(tmp_path, setup_logging, temp_output_dir):
    ...
    """
    xml_file = tmp_path / "test_input_unpublished_access_date_bt1252.xml"
