...
def test_bt_536_lot_integration(tmp_path):
    ...
    assert "startDate" in lot["contractPeriod"], "Expected 'startDate' in lot contractPeriod"
    expected_start_date = "2019-11-15T00:00:00+01:00"
    assert lot["contractPeriod"]["startDate"] == expected_start_date, f"Expected start date '{expected_start_date}', got {lot['contractPeriod']['startDate']}"
