# tests/test_BT_197_BT_5422_Lot.py
...
def test_bt_197_bt_5422_lot_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_bt_197_bt_5422_lot.xml"
    ...
    bt_5422_item = next((item for item in result["withheldInformation"] if item.get("id") == "BT-195(BT-5422)-Lot"), None)
    assert bt_5422_item is not None, "No withheld information item for BT-195(BT-5422)-Lot found"
