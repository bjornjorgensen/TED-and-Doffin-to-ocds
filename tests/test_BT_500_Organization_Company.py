...
def test_bt_500_organization_company_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_organization_name.xml"
    ...
    assert "name" in party, "Expected 'name' in party"
    assert party["name"] == "Ministry of Education", f"Expected name 'Ministry of Education', got {party['name']}"
