...
def test_bt_510a_ubo_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_ubo_street.xml"
    ...
    assert ubo["address"]["streetAddress"] == expected_street_address, f"Expected street address '{expected_street_address}', got {ubo['address']['streetAddress']}"
