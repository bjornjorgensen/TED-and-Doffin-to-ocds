...
def test_bt_197_bt_5423_lotsgroup_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_bt_197_bt_5423_lotsgroup.xml"
    ...
    bt_5423_item = next((item for item in result["withheldInformation"] if item.get("id") == "BT-195(BT-5423)-LotsGroup"), None)
    assert bt_5423_item is not None, "No withheld information item for BT-195(BT-5423)-LotsGroup found"
