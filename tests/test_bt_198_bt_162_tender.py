# tests/test_bt_198_bt_162_Tender.py
...
def test_bt198_bt162_unpublished_access_date_integration(tmp_path, setup_logging):
    ...
    """
    xml_file = tmp_path / "test_input_bt198_bt162.xml"
...
def test_bt198_bt162_unpublished_access_date_missing_data(tmp_path, setup_logging):
    logger = setup_logging
    xml_content = """
    <root xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
          xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2"
    ...
    """
    xml_file = tmp_path / "test_input_bt198_bt162_missing.xml"
    xml_file.write_text(xml_content)
