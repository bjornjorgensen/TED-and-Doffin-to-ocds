...
def test_bt_506_organization_touchpoint_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_touchpoint_contact_email.xml"
    ...
    assert party["contactPoint"]["email"] == "abc@xyz.europa.eu", f"Expected email 'abc@xyz.europa.eu', got {party['contactPoint']['email']}"
