# tests/test_BT_197_BT_541_LotsGroup_Fixed.py
...
def test_bt_197_bt_541_lotsgroup_fixed_integration(tmp_path):
    xml_content = """
                                    ...
                                    <ext:ExtensionContent>
                                        <efext:EformsExtension>
                                            <efac:AwardCriterionParameter>
                                                <efbc:ParameterCode listName="number-fixed">fixed-number</efbc:ParameterCode>
                                                <efac:FieldsPrivacy>
    ...
    """
    xml_file = tmp_path / "test_input_bt_197_bt_541_lotsgroup_fixed.xml"
    ...
    bt_541_item = next((item for item in result["withheldInformation"] if item.get("id") == "BT-195(BT-541)-LotsGroup-Fixed"), None)
    assert bt_541_item is not None, "No withheld information item for BT-195(BT-541)-LotsGroup-Fixed found"
