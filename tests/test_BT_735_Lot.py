...
def test_bt_735_lot_integration(tmp_path):
    ...
    assert "additionalClassifications" in lot, "Expected 'additionalClassifications' in lot"
    assert len(lot["additionalClassifications"]) == 1, f"Expected 1 additional classification, got {len(lot['additionalClassifications'])}"
