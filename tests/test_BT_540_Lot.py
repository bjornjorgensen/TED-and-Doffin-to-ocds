...
def test_parse_award_criterion_description():
    ...
    assert lot["awardCriteria"]["criteria"][0]["description"] == "Tenders with a quality score less than 65..."
...
def test_merge_award_criterion_description():
    ...
    assert {"description": "Tenders with a quality score less than 65..."} in lot1["awardCriteria"]["criteria"]
    
    lot2 = release_json["tender"]["lots"][1]
    assert lot2["id"] == "LOT-0002"
    assert len(lot2["awardCriteria"]["criteria"]) == 1
    assert lot2["awardCriteria"]["criteria"][0]["description"] == "Another criterion description"
