...
def test_bt_16_organization_part_name_integration(tmp_path):
    xml_content = """
    ...
    assert party["name"] == "Ministry of Education - Procurement Department", f"Expected name 'Ministry of Education - Procurement Department', got {party['name']}"
