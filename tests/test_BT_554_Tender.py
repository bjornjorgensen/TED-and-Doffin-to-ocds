...
def test_bt_554_tender_integration(tmp_path):
    ...
    assert "description" in bid["subcontracting"], "Expected 'description' in bid subcontracting"
    assert bid["subcontracting"]["description"] == "The subcontracting will be...", f"Expected description 'The subcontracting will be...', got {bid['subcontracting']['description']}"
