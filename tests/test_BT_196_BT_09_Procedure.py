...
def test_bt_196_bt_09_procedure_integration(tmp_path):
    xml_content = """
    ...
    assert withheld_item["rationale"] == "Information delayed publication because of ...", f"Expected rationale 'Information delayed publication because of ...', got {withheld_item['rationale']}"
