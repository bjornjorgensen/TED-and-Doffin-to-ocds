...
def test_bt_63_lot_integration(tmp_path):
    ...
    assert "variantPolicy" in lot["submissionTerms"], "Expected 'variantPolicy' in submissionTerms"
    assert lot["submissionTerms"]["variantPolicy"] == "Allowed", f"Expected variantPolicy 'Allowed', got {lot['submissionTerms']['variantPolicy']}"
