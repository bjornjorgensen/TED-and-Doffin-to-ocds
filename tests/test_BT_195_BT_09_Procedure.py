...
def test_bt_195_bt_09_procedure_integration(tmp_path):
    ...
    assert withheld_info["id"] == "cro-bor-law-18d27a53-0109-4f93-9231-6659d931bce0"
    assert withheld_info["field"] == "cro-bor-law"
    assert withheld_info["name"] == "Cross Border Law"
