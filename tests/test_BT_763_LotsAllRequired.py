...
def test_bt_763_lots_all_required_not_all(tmp_path, setup_logging):
    ...
    assert "tender" not in result or ("lotDetails" not in result.get("tender", {})), "Did not expect 'lotDetails' in result when PartPresentationCode is not 'all'"
...
def test_bt_763_lots_all_required_missing_element(tmp_path, setup_logging):
    ...
    assert "tender" not in result or ("lotDetails" not in result.get("tender", {})), "Did not expect 'lotDetails' in result when PartPresentationCode is missing"
...
def test_bt_763_lots_all_required_empty_value(tmp_path, setup_logging):
    ...
    assert "tender" not in result or ("lotDetails" not in result.get("tender", {})), "Did not expect 'lotDetails' in result when PartPresentationCode is empty"
