...
def test_bt_09_procedure_integration(tmp_path, setup_logging, temp_output_dir):
...
def test_bt_09_procedure_integration_missing(tmp_path, setup_logging, temp_output_dir):
    logger = setup_logging
