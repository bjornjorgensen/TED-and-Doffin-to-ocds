...
def test_bt_505_organization_touchpoint_integration(tmp_path):
    ...
    assert party["details"]["url"] == "http://abc.europa.eu/", f"Expected url 'http://abc.europa.eu/', got {party['details']['url']}"
    ...
    assert "eDeliveryGateway" not in party.get("details", {}), "Unexpected 'eDeliveryGateway' in party details"
