...
def test_parse_employment_legislation_document_id(sample_xml) -> None:
...
def test_merge_employment_legislation_document_id() -> None:
...
def test_merge_employment_legislation_document_id_existing_document() -> None:
    employment_legislation_data = {
        "tender": {
            "documents": [
                {
...
def test_parse_employment_legislation_document_id_no_data() -> None:
    xml_content = "<root></root>"
    result = parse_employment_legislation_document_id(xml_content)
    assert result is None


def test_merge_employment_legislation_document_id_no_data() -> None:
    release_json = {}
