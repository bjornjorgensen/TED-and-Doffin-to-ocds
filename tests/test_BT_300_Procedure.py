...
def test_parse_procedure_additional_info():
    xml_content = """
...
def test_merge_procedure_additional_info():
    release_json = {}
    procedure_additional_info = [{'text': 'For the current procedure ...', 'language': 'ENG'}]
...
def test_merge_procedure_additional_info_existing_description():
...
def test_merge_multiple_procedure_additional_info():
    release_json = {}
