...
def test_bt_109_lot_integration(tmp_path):
    ...
    assert lot_1["techniques"]["frameworkAgreement"]["periodRationale"] == "The exceptional duration of ...", "Unexpected periodRationale for LOT-0001"
    ...
    assert lot_2["techniques"]["frameworkAgreement"]["periodRationale"] == "Another exceptional duration...", "Unexpected periodRationale for LOT-0002"
