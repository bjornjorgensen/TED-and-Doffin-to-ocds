...
def test_bt_755_lot_integration(tmp_path, setup_logging, temp_output_dir) -> None:
    ...
    # logger.info("Test bt_755_lot_integration passed successfully.") # Logging disabled
