...
def test_bt_130_lot_integration(tmp_path):
    ...
    assert "invitationDate" in lot["secondStage"], "Expected 'invitationDate' in secondStage"
    assert lot["secondStage"]["invitationDate"] == "2019-11-15T00:00:00+01:00", f"Expected invitationDate '2019-11-15T00:00:00+01:00', got {lot['secondStage']['invitationDate']}"
