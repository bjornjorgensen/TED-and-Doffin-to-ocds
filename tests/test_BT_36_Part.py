...
def test_bt_36_part_integration(tmp_path):
    ...
    assert "durationInDays" in result["tender"]["contractPeriod"], "Expected 'durationInDays' in contractPeriod"
    assert result["tender"]["contractPeriod"]["durationInDays"] == 3, f"Expected duration 3 days, got {result['tender']['contractPeriod']['durationInDays']}"
...
def test_bt_36_part_integration_month(tmp_path):
    ...
    assert result["tender"]["contractPeriod"]["durationInDays"] == 60, f"Expected duration 60 days, got {result['tender']['contractPeriod']['durationInDays']}"
...
def test_bt_36_part_integration_week(tmp_path):
    ...
    assert result["tender"]["contractPeriod"]["durationInDays"] == 14, f"Expected duration 14 days, got {result['tender']['contractPeriod']['durationInDays']}"
