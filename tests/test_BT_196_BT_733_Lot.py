# tests/test_BT_196_BT_733_Lot.py
...
def test_bt_196_bt_733_lot_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_bt_196_bt_733_lot.xml"
    ...
    assert withheld_info["id"] == "awa-cri-ord-1", f"Expected id 'awa-cri-ord-1', got {withheld_info['id']}"
