...
def test_bt_5101b_part_integration(tmp_path, setup_logging, temp_output_dir) -> None:
    ...
    """
    xml_file = tmp_path / "test_input_part_place_performance_streetline1.xml"
