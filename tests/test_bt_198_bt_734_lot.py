# tests/test_bt_198_bt_734_Lot.py
...
def test_bt_198_bt734_lot_integration(tmp_path, setup_logging, temp_output_dir):
    ...
    """
    xml_file = tmp_path / "test_input_bt198_bt734_lot.xml"
...
def test_bt_198_bt734_lot_missing_field(tmp_path, setup_logging, temp_output_dir):
    logger = setup_logging
    xml_content = """
    <ContractNotice xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
          xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2"
    ...
    """
    xml_file = tmp_path / "test_input_bt198_bt734_lot_missing.xml"
    xml_file.write_text(xml_content)
