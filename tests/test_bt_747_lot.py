...
def test_bt_747_lot_integration(tmp_path, setup_logging, temp_output_dir):
    ...
    criteria_types = [c["type"] for c in lot["selectionCriteria"]["criteria"]]
    assert "economic" in criteria_types, "Expected 'economic' in criterion types"
    assert "technical" in criteria_types, "Expected 'technical' in criterion types"

    logger.info("Test bt_747_lot_integration passed successfully.")
