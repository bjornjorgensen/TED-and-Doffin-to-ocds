# tests/test_BT_197_BT_5421_Lot.py
...
def test_bt_197_bt_5421_lot_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_bt_197_bt_5421_lot.xml"
    ...
    bt_5421_item = next((item for item in result["withheldInformation"] if item.get("id") == "BT-195(BT-5421)-Lot"), None)
    assert bt_5421_item is not None, "No withheld information item for BT-195(BT-5421)-Lot found"
