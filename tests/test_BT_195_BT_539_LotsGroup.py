...
def test_bt_195_bt_539_lotsgroup_integration(tmp_path, setup_logging):
    ...
    """
    xml_file = tmp_path / "test_input_unpublished_award_criterion_type_lotsgroup.xml"
    ...
    assert withheld_info["id"] == "awa-cri-typ-GLO-0001"
    assert withheld_info["field"] == "awa-cri-typ"
    assert withheld_info["name"] == "Award Criterion Type"
