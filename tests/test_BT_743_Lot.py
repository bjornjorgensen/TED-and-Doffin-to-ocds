...
def test_bt_743_lot_integration(tmp_path):
    ...
    assert "electronicInvoicingPolicy" in lot["contractTerms"], "Expected 'electronicInvoicingPolicy' in contractTerms"
    assert lot["contractTerms"]["electronicInvoicingPolicy"] == "required", \
