# tests/test_BT_196_BT_5423_LotsGroup.py
...
def test_bt_196_bt_5423_lotsgroup_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_bt_196_bt_5423_lotsgroup.xml"
    ...
    awa_cri_thr_item = next((item for item in result["withheldInformation"] if item.get("id") == "awa-cri-thr-group-group-1"), None)
    assert awa_cri_thr_item is not None, "No withheld information item for awarding criterion threshold number (LotsGroup) found"
