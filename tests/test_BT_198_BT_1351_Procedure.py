# tests/test_BT_198_BT_1351_Procedure.py
...
def test_bt_198_bt_1351_procedure_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_unpublished_access_date_bt1351.xml"
