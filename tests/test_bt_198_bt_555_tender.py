# tests/test_bt_198_bt_555_Tender.py
...
def test_bt_198_bt555_tender_integration(tmp_path, setup_logging, temp_output_dir):
    ...
    """
    xml_file = tmp_path / "test_input_bt198_bt555.xml"
