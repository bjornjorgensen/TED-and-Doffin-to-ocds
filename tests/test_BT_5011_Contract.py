...
def test_bt_5011_contract_integration(tmp_path):
    ...
    contract = next((contract for contract in result["contracts"] if contract["id"] == "CON-0001"), None)
    ...
    assert finance[0]["id"] == "2021/1234", f"Expected finance id '2021/1234', got {finance[0]['id']}"
