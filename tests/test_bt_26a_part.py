...
def test_bt_26a_part_integration(tmp_path, setup_logging, temp_output_dir) -> None:
    ...
    xml_file = tmp_path / "test_input_classification_type_part.xml"
