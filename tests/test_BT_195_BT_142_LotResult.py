# tests/test_BT_195_BT_142_LotResult.py
...
def test_bt_195_bt_142_unpublished_winner_chosen_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_unpublished_winner_chosen.xml"
    ...
    assert withheld_info["id"] == "win-cho-RES-0001", f"Expected id 'win-cho-RES-0001', got {withheld_info['id']}"
