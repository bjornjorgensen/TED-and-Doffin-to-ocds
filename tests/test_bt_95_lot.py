...
from src.ted_and_doffin_to_ocds.converters.eforms.bt_95_lot import (
...
def test_parse_recurrence_description() -> None:
    ...
    assert (
        result["tender"]["lots"][0]["recurrence"]["description"]
        == "The current procurement ..."
    )


def test_merge_recurrence_description() -> None:
    ...
    recurrence_description_data = {
        "tender": {
            "lots": [
                {
                    "id": "LOT-0001",
                    "recurrence": {"description": "The current procurement ..."},
                },
            ],
        },
    }
    ...
    assert (
        release_json["tender"]["lots"][0]["recurrence"]["description"]
        == "The current procurement ..."
    )


def test_bt_95_lot_recurrence_description_integration(
