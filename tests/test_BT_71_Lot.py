...
def test_parse_reserved_participation():
    ...
    assert result["tender"]["lots"][0]["otherRequirements"]["reservedParticipation"] == ["shelteredWorkshop"]
...
def test_merge_reserved_participation():
    ...
    assert "reservedParticipation" in release_json["tender"]["lots"][0]["otherRequirements"]
    assert release_json["tender"]["lots"][0]["otherRequirements"]["reservedParticipation"] == ["shelteredWorkshop"]
