# tests/test_BT_197_BT_541_Lot_Fixed.py
...
def test_bt_197_bt_541_lot_fixed_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_bt_197_bt_541_lot_fixed.xml"
    ...
    bt_541_item = next((item for item in result["withheldInformation"] if "rationaleClassifications" in item), None)
    assert bt_541_item is not None, "No withheld information item with rationaleClassifications found"
