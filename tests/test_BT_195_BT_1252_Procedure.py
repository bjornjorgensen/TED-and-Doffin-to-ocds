...
def test_bt_195_bt_1252_unpublished_direct_award_justification_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_unpublished_direct_award_justification.xml"
