...
def test_bt_732_lot_integration(tmp_path):
    ...
    assert "securityClearance" in lot["otherRequirements"], "Expected 'securityClearance' in otherRequirements"
    ...
    assert lot["otherRequirements"]["securityClearance"] == expected_description, \
