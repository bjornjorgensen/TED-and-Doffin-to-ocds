...
def test_bt_134_lot_public_opening_description_integration(
    ...
    assert (
        lot["bidOpening"]["description"] == "Any tenderer may attend ..."
    ), f"Expected description 'Any tenderer may attend ...', got {lot['bidOpening']['description']}"
