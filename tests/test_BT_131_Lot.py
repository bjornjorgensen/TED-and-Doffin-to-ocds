...
def test_bt_131_lot_integration(tmp_path):
    xml_content = """
    ...
    assert lot["tenderPeriod"]["endDate"] == "2019-11-30T12:00:00+01:00", f"Expected endDate '2019-11-30T12:00:00+01:00', got {lot['tenderPeriod']['endDate']}"
