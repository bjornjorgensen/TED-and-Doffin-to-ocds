...
def test_bt_801_lot_non_disclosure_agreement_integration(tmp_path):
    ...
    nda_lots = [lot for lot in result["tender"]["lots"] if "contractTerms" in lot and "hasNonDisclosureAgreement" in lot["contractTerms"]]
    ...
    assert "contractTerms" not in lot_2 or "hasNonDisclosureAgreement" not in lot_2.get("contractTerms", {})
