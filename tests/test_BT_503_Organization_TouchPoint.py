...
def test_bt_503_organization_touchpoint_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_touchpoint_contact_telephone.xml"
    ...
    assert party["contactPoint"]["telephone"] == "+123 45678", f"Expected telephone '+123 45678', got {party['contactPoint']['telephone']}"
