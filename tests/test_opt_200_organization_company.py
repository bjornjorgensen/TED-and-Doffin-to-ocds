...
def test_parse_organization_technical_identifier() -> None:
    xml_content = """
...
def test_merge_organization_technical_identifier() -> None:
...
def test_merge_organization_technical_identifier_existing_party() -> None:
