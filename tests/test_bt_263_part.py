...
def test_parse_additional_classification_code_part(sample_xml):
...
def test_parse_additional_classification_code_part_no_data():
    ...
    """
    result = parse_additional_classification_code_part(xml_no_classifications)
    assert result is None


def test_merge_additional_classification_code_part():
    release_json = {
        "tender": {
            "items": [
                {
    ...
    merge_additional_classification_code_part(release_json, additional_data)
...
def test_bt_263_part_integration(tmp_path) -> None:
    xml_content = """
    <ContractNotice xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
          xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2">
        <cac:ProcurementProjectLot>
