...
def test_bt_738_notice_integration(tmp_path):
    ...
    assert "noticePreferredPublicationDate" in result["tender"]["communication"], "Expected 'noticePreferredPublicationDate' in communication"
    assert result["tender"]["communication"]["noticePreferredPublicationDate"] == "2020-03-15T00:00:00+01:00", \
