...
def test_bt_195_bt_540_lotsgroup_integration(tmp_path, setup_logging):
    ...
    """
    xml_file = tmp_path / "test_input_unpublished_award_criterion_description_lotsgroup.xml"
    ...
    assert withheld_info["id"] == "awa-cri-des-GLO-0001"
    assert withheld_info["field"] == "awa-cri-des"
    assert withheld_info["name"] == "Award Criterion Description"
