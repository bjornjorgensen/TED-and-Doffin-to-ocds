...
def test_bt_195_bt_555_unpublished_subcontracting_percentage_tender_integration(tmp_path, caplog):
    ...
    """
    xml_file = tmp_path / "test_input_unpublished_subcontracting_percentage_tender.xml"
