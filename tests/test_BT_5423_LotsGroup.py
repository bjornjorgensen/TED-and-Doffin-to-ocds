...
def test_parse_award_criterion_number_threshold_lotsgroup_max_pass():
    ...
    assert result["tender"]["lotGroups"][0]["awardCriteria"]["criteria"][0]["numbers"][0]["threshold"] == "maximumBids"
...
def test_parse_award_criterion_number_threshold_lotsgroup_min_score():
    ...
    assert result["tender"]["lotGroups"][0]["awardCriteria"]["criteria"][0]["numbers"][0]["threshold"] == "minimumScore"
...
def test_merge_award_criterion_number_threshold_lotsgroup():
    ...
    assert len(existing_release["tender"]["lotGroups"][0]["awardCriteria"]["criteria"]) == 1
    assert len(existing_release["tender"]["lotGroups"][0]["awardCriteria"]["criteria"][0]["numbers"]) == 1
    assert existing_release["tender"]["lotGroups"][0]["awardCriteria"]["criteria"][0]["numbers"][0]["threshold"] == "maximumBids"
...
def test_merge_award_criterion_number_threshold_lotsgroup_new_group():
    ...
    assert existing_release["tender"]["lotGroups"][0]["awardCriteria"]["criteria"][0]["numbers"][0]["threshold"] == "minimumScore"
