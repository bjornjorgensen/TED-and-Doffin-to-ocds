...
def test_bt_195_bt_5423_unpublished_award_criterion_number_threshold_lot_integration(tmp_path, caplog):
    ...
    """
    xml_file = tmp_path / "test_input_unpublished_award_criterion_number_threshold_lot.xml"
