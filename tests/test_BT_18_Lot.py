...
def test_bt_18_lot_integration(tmp_path):
    ...
    assert lot["submissionMethodDetails"] == "https://www.acme.com/tender-submission/", f"Expected submissionMethodDetails 'https://www.acme.com/tender-submission/', got {lot['submissionMethodDetails']}"
