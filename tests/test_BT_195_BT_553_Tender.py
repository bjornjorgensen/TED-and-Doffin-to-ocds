...
def test_bt_195_bt_553_unpublished_subcontracting_value_tender_integration(tmp_path, caplog):
    ...
    """
    xml_file = tmp_path / "test_input_unpublished_subcontracting_value_tender.xml"
