...
def test_bt_502_organization_company_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_organization_contact_point.xml"
    ...
    assert party["contactPoint"]["name"] == "Press Department", f"Expected contact point name 'Press Department', got {party['contactPoint']['name']}"
