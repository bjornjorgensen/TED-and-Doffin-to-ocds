# tests/test_bt_510c_organization_touchpoint.py
...
def test_bt_510c_organization_touchpoint_integration(tmp_path, setup_logging, temp_output_dir):
    ...
    """
    xml_file = tmp_path / "test_input_touchpoint_streetline2.xml"
