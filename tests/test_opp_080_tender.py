...
def test_opp_080_kilometers_public_transport_integration(
    ...
    assert (
        contract["publicPassengerTransportServicesKilometers"] == 988754432110987
    ), f"Expected publicPassengerTransportServicesKilometers 988754432110987, got {contract['publicPassengerTransportServicesKilometers']}"
    assert (
