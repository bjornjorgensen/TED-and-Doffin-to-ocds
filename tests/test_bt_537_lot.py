...
def test_parse_lot_duration_end_date() -> None:
    xml_content = """
    ...
    assert (
        result["tender"]["lots"][0]["contractPeriod"]["endDate"]
        == "2019-11-19T23:59:59+01:00"
    )


def test_merge_lot_duration_end_date() -> None:
    ...
    assert (
        release_json["tender"]["lots"][0]["contractPeriod"]["endDate"]
        == "2019-11-19T23:59:59+01:00"
    )
