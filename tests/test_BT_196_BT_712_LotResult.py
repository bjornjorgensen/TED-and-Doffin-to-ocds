# tests/test_BT_196_BT_712_LotResult.py
...
def test_bt_196_bt_712_lot_result_integration(tmp_path):
    xml_content = """
        ...
        <efac:NoticeResult>
            <efac:LotResult>
                <efac:AppealRequestsStatistics>
                    <efbc:StatisticsCode listName="review-type">some-code</efbc:StatisticsCode>
                    <efac:FieldsPrivacy>
                        <efbc:FieldIdentifierCode>rev-req</efbc:FieldIdentifierCode>
                        <efbc:ReasonDescription>Information delayed publication due to ongoing review process</efbc:ReasonDescription>
                    </efac:FieldsPrivacy>
                </efac:AppealRequestsStatistics>
            </efac:LotResult>
        </efac:NoticeResult>
    ...
    """
    xml_file = tmp_path / "test_input_bt_196_bt_712_lot_result.xml"
    ...
    expected_rationale = "Information delayed publication due to ongoing review process"
