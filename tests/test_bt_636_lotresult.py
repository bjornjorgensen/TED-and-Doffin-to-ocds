...
def test_bt_636_lotresult_integration(tmp_path, setup_logging, temp_output_dir) -> None:
    ...
    # logger.info("Test bt_636_lotresult_integration passed successfully.") # Logging disabled
