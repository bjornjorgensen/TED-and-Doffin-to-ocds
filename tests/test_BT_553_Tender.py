...
def test_bt_553_tender_integration(tmp_path):
    ...
    assert bid["subcontracting"]["value"]["amount"] == 9999999.99, f"Expected amount 9999999.99, got {bid['subcontracting']['value']['amount']}"
    assert bid["subcontracting"]["value"]["currency"] == "EUR", f"Expected currency 'EUR', got {bid['subcontracting']['value']['currency']}"
