...
def test_bt_506_ubo_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_ubo_email.xml"
    ...
    assert ubo["email"] == "mickey.mouse@cheese-universe.com", f"Expected email 'mickey.mouse@cheese-universe.com', got {ubo['email']}"
