# tests/test_BT_512_Organization_Company.py
...
def test_bt_512_organization_company_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_organization_postcode.xml"
