...
def test_opp_051_organization_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_awarding_cpb_buyer.xml"
    ...
    assert "procuringEntity" in result["parties"][0]["roles"]

def test_opp_051_organization_integration_false(tmp_path):
    xml_content = """
    <root xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
          xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2"
          xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2"
    ...
    """
    xml_file = tmp_path / "test_input_awarding_cpb_buyer_false.xml"
    xml_file.write_text(xml_content)
