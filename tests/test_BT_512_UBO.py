...
def test_bt_512_ubo_integration(tmp_path):
    xml_content = """
    ...
    """
    xml_file = tmp_path / "test_input_ubo_postcode.xml"
    ...
    assert ubo["address"]["postalCode"] == "C6HA782", f"Expected postal code 'C6HA782', got {ubo['address']['postalCode']}"
