...
from converters.OPT_300_Procedure_Buyer import parse_procedure_buyer, merge_procedure_buyer
...
def main(xml_path, ocid_prefix):
   ...
   # Parse the organization info (BT-500 and BT-501)
    ...
    # Parse and merge OPT-300 procedure_buyer
    buyer_data = parse_procedure_buyer(xml_content)
    if buyer_data:
        merge_procedure_buyer(release_json, buyer_data)
    else:
        logger.warning("No Procedure Buyer data found")
