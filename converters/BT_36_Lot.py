...
def parse_lot_duration(xml_content):
    ...
    for lot in lots:
        ...
        duration_measure = lot.xpath("cac:ProcurementProject/cac:PlannedPeriod/cbc:DurationMeasure", namespaces=namespaces)
...
def merge_lot_duration(release_json, lot_duration_data):
    ...
    logger.info(f"Merged lot duration data for {len(lot_duration_data['tender']['lots'])} lots")