...
def parse_bt198_bt106_unpublished_access_date(xml_content):
    """
    Parse the XML content to extract the unpublished access date for the accelerated procedure.
    ...
    publication_date = root.xpath("//cac:TenderingProcess/cac:ProcessJustification[cbc:ProcessReasonCode/@listName='accelerated-procedure']/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='pro-acc']/efbc:PublicationDate/text()", namespaces=namespaces)
...
def merge_bt198_bt106_unpublished_access_date(release_json, unpublished_access_date_data):
    """
    ...
    logger.info("Merged unpublished access date data for BT-198(BT-106)")