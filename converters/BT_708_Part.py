...
def parse_part_documents_official_language(xml_content):
    """
    Parse the XML content to extract the official languages for documents in each part.
...
def merge_part_documents_official_language(release_json, part_documents_data):
    ...
    logger.info(f"Merged part documents official language data for {len(part_documents_data['tender']['documents'])} documents")