...
def parse_organization_postcode(xml_content):
    ...
    for organization in organizations:
        ...
        postal_zone = organization.xpath("efac:Company/cac:PostalAddress/cbc:PostalZone/text()", namespaces=namespaces)
...
def merge_organization_postcode(release_json, organization_postcode_data):
    ...
    logger.info(f"Merged Organization Postcode data for {len(organization_postcode_data['parties'])} parties")