...
def parse_procedure_place_performance_streetline2(xml_content):
...
def merge_procedure_place_performance_streetline2(release_json, procedure_place_performance_streetline2_data):
    ...
    for new_address in procedure_place_performance_streetline2_data["tender"]["deliveryAddresses"]:
