...
def parse_organization_website(xml_content):
    ...
    for organization in organizations:
        ...
        website_uri = organization.xpath("efac:Company/cbc:WebsiteURI/text()", namespaces=namespaces)
...
def merge_organization_website(release_json, organization_website_data):
    ...
    logger.info(f"Merged Organization Website data for {len(organization_website_data['parties'])} parties")