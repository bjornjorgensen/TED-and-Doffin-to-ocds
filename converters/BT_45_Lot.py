...
def merge_lot_rewards_other(release_json, lot_rewards_other_data):
    ...
    for new_lot in lot_rewards_other_data["tender"]["lots"]:
        ...
        if existing_lot:
            existing_prizes = existing_lot.setdefault("designContest", {}).setdefault("prizes", {}).setdefault("details", [])
    ...
    logger.info(f"Merged Lot Rewards Other data for {len(lot_rewards_other_data['tender']['lots'])} lots")