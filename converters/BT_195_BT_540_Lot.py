...
def parse_unpublished_award_criterion_description(xml_content):
...
def merge_unpublished_award_criterion_description(release_json, unpublished_award_criterion_description_data):
    ...
    for new_withheld_info in unpublished_award_criterion_description_data["withheldInformation"]:
