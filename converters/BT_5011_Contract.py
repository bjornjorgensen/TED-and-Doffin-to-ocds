...
def merge_contract_eu_funds_financing_identifier(release_json, contract_eu_funds_financing_identifier_data):
    ...
    logger.info(f"Merged Contract EU Funds Financing Identifier data for {len(contract_eu_funds_financing_identifier_data['contracts'])} contracts")