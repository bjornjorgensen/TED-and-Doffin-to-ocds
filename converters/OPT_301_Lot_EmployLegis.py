...
def parse_employment_legislation_document_reference(xml_content):
    ...
    for lot in lots:
        ...
        organization_ids = lot.xpath(
            "cac:TenderingTerms/cac:EmploymentLegislationDocumentReference/cac:IssuerParty/cac:PartyIdentification/cbc:ID[@schemeName='organization']/text()",
            namespaces=namespaces,
        )
...
def merge_employment_legislation_document_reference(
