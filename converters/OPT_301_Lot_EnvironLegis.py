...
def parse_environmental_legislation_document_reference(xml_content):
    ...
    for lot in lots:
        ...
        document_reference_ids = lot.xpath("cac:TenderingTerms/cac:EnvironmentalLegislationDocumentReference/cbc:ID/text()", namespaces=namespaces)
        ...
        organization_ids = lot.xpath("cac:TenderingTerms/cac:EnvironmentalLegislationDocumentReference/cac:IssuerParty/cac:PartyIdentification/cbc:ID[@schemeName='organization']/text()", namespaces=namespaces)
...
def merge_environmental_legislation_document_reference(release_json, environmental_legislation_data):
    ...
    logger.info(f"Merged Environmental Legislation Document Reference for {len(environmental_legislation_data.get('parties', []))} parties")
