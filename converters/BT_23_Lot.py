...
def parse_main_nature(xml_content):
    ...
    for lot in lots:
        ...
        procurement_type = lot.xpath("cac:ProcurementProject/cbc:ProcurementTypeCode[@listName='contract-nature']/text()", namespaces=namespaces)
...
def merge_main_nature(release_json, main_nature_data):
    ...
    logger.info(f"Merged Main Nature data for {len(main_nature_data['tender']['lots'])} lots")