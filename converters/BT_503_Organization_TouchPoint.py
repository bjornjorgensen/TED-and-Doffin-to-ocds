...
def parse_touchpoint_contact_telephone(xml_content):
    ...
    for organization in organizations:
        ...
        contact_telephone = organization.xpath("efac:TouchPoint/cac:Contact/cbc:Telephone/text()", namespaces=namespaces)
...
def merge_touchpoint_contact_telephone(release_json, touchpoint_contact_telephone_data):
    ...
    logger.info(f"Merged TouchPoint Contact Telephone data for {len(touchpoint_contact_telephone_data['parties'])} parties")