...
def parse_organization_city(xml_content):
    ...
    for organization in organizations:
        ...
        city_name = organization.xpath("efac:Company/cac:PostalAddress/cbc:CityName/text()", namespaces=namespaces)
...
def merge_organization_city(release_json, city_data):
    ...
    logger.info(f"Merged Organization City data for {len(city_data['parties'])} parties")