...
def parse_award_criterion_number_threshold(xml_content):
    ...
    for lot in lots:
        ...
        award_criteria = lot.xpath(".//cac:AwardingCriterion/cac:SubordinateAwardingCriterion", namespaces=namespaces)
...
def merge_award_criterion_number_threshold(release_json, award_criterion_data):
    ...
    logger.info(f"Merged Award Criterion Number Threshold data for {len(award_criterion_data['tender']['lots'])} lots")