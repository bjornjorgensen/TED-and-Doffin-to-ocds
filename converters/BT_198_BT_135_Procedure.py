...
def parse_bt198_bt135_unpublished_access_date(xml_content):
    ...
    publication_date = root.xpath("//cac:TenderingProcess/cac:ProcessJustification[cbc:ProcessReasonCode/@listName='direct-award-justification']/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='dir-awa-tex']/efbc:PublicationDate/text()", namespaces=namespaces)
...
def merge_bt198_bt135_unpublished_access_date(release_json, unpublished_access_date_data):
    """
