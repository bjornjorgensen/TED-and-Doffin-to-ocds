...
def parse_vehicle_type(xml_content):
    ...
    for lot_result in lot_results:
        ...
        vehicle_types = lot_result.xpath(".//efac:StrategicProcurementStatistics[efbc:StatisticsNumeric != '0']/efbc:StatisticsCode[@listName='vehicles']/text()", namespaces=namespaces)
...
def merge_vehicle_type(release_json, vehicle_type_data):
    ...
    logger.info(f"Merged vehicle type data for {len(vehicle_type_data['awards'])} awards")