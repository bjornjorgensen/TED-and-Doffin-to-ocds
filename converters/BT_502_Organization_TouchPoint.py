...
def parse_touchpoint_contact_point(xml_content):
    ...
    for organization in organizations:
        ...
        contact_name = organization.xpath("efac:TouchPoint/cac:Contact/cbc:Name/text()", namespaces=namespaces)
...
def merge_touchpoint_contact_point(release_json, touchpoint_contact_point_data):
    ...
    logger.info(f"Merged TouchPoint Contact Point data for {len(touchpoint_contact_point_data['parties'])} parties")