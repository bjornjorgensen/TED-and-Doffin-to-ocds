...
def parse_unpublished_award_criterion_number_weight_lotsgroup_bt541(xml_content):
    ...
    for element in elements:
        ...
        withheld_item = {
            "id": f"{field_identifier_code}-weight-{lots_group_id}",
            "field": "awa-cri-num",
...
def merge_unpublished_award_criterion_number_weight_lotsgroup_bt541(release_json, parsed_data):
    if not parsed_data:
