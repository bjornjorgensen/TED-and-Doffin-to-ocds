...
def parse_lot_selection_criteria_second_stage(xml_content):
    ...
    for lot in lots:
        ...
        selection_criteria = lot.xpath(".//efac:SelectionCriteria[efbc:SecondStageIndicator='true']", namespaces=namespaces)
...
def merge_lot_selection_criteria_second_stage(release_json, lot_selection_criteria_data):
    ...
    logger.info(f"Merged lot selection criteria second stage data for {len(lot_selection_criteria_data['tender']['lots'])} lots")