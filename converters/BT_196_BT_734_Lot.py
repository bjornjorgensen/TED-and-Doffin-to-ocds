...
def parse_bt_196_bt_734_lot(xml_content):
        ...
        if fields_privacy:
            ...
            if reason_description:
                result["withheldInformation"].append({
                    "id": "awa-cri-nam-" + lot.xpath("cbc:ID/text()", namespaces=namespaces)[0],
                    "field": "awa-cri-nam",
...
def merge_bt_196_bt_734_lot(release_json, bt_196_data):
    if not bt_196_data:
        return
