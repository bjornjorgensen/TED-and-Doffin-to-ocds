...
def parse_bt_271_lot(xml_content):
    ...
    for lot_element in lot_elements:
        ...
        amount_element = lot_element.xpath("cac:ProcurementProject/cac:RequestedTenderTotal/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efbc:FrameworkMaximumAmount", namespaces=namespaces)
...
def merge_bt_271_lot(release_json, bt_271_lot_data):
    ...
    logger.info(f"Merged BT-271-Lot Framework Maximum Value data for {len(bt_271_lot_data['tender']['lots'])} lots")