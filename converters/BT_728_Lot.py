...
def merge_lot_place_performance_additional(release_json, lot_place_performance_additional_data):
    """
    ...
    logger.info(f"Merged additional place of performance data for {len(lot_place_performance_additional_data['tender']['items'])} lots")