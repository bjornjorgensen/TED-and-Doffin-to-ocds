# converters/BT_5101c_Part.py

from lxml import etree

def parse_part_place_performance_streetline2(xml_content):
...
def merge_part_place_performance_streetline2(release_json, part_place_performance_streetline2_data):
    ...
    for new_address in part_place_performance_streetline2_data["tender"]["deliveryAddresses"]:
