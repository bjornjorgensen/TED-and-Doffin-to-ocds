...
def parse_lot_duration_other(xml_content):
    ...
    for lot in lots:
        ...
        duration_code = lot.xpath("cac:ProcurementProject/cac:PlannedPeriod/cbc:DescriptionCode[@listName='timeperiod']/text()", namespaces=namespaces)
...
def merge_lot_duration_other(release_json, lot_duration_other_data):
    ...
    logger.info(f"Merged Lot Duration Other data for {len(lot_duration_other_data['tender']['lots'])} lots")