...
def parse_part_employlegis(xml_content):
    ...
    for ref in employ_legis_refs:
        ...
        uri = ref.xpath("cac:Attachment/cac:ExternalReference/cbc:URI/text()", namespaces=namespaces)
...
def merge_part_employlegis(release_json, employlegis_data):
    ...
    logger.info(f"Merged Part Employment Legislation data for {len(employlegis_data['tender']['documents'])} documents")