...
def parse_unpublished_tender_lowest_value_lotresult_bt710(xml_content):
    ...
    xpath = "/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeResult/efac:LotResult/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='ten-val-low']"
...
def merge_unpublished_tender_lowest_value_lotresult_bt710(release_json, withheld_info_data):
