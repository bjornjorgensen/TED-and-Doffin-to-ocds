...
def parse_touchpoint_country_subdivision(xml_content):
    ...
    for organization in organizations:
        ...
        country_subentity_code = organization.xpath("efac:TouchPoint/cac:PostalAddress/cbc:CountrySubentityCode[@listName='nuts']/text()", namespaces=namespaces)
...
def merge_touchpoint_country_subdivision(release_json, touchpoint_country_subdivision_data):
    ...
    logger.info(f"Merged touchpoint country subdivision data for {len(touchpoint_country_subdivision_data['parties'])} parties")