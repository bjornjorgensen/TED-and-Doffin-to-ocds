...
def parse_unpublished_direct_award_justification(xml_content):
...
def merge_unpublished_direct_award_justification(release_json, unpublished_direct_award_justification_data):
