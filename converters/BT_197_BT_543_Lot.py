# converters/BT_197_BT_543_Lot.py
...
def parse_bt_197_bt_543_lot(xml_content):
    ...
    xpath = "/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:AwardingTerms/cac:AwardingCriterion/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='awa-cri-com']/cbc:ReasonCode"
...
def merge_bt_197_bt_543_lot(release_json, bt_197_bt_543_data):
    if not bt_197_bt_543_data:
        logger.warning("No BT-197(BT-543)-Lot data to merge")
        return
    ...
    for withheld_item in release_json['withheldInformation']:
        if withheld_item.get('id') == "BT-195(BT-543)-Lot":
