...
def BT_195_parse_unpublished_award_criterion_description_lotsgroup_bt540(xml_content):
    """
    Parse the XML content to extract the unpublished award criterion description for lots groups (BT-195, BT-540).
...
def BT_195_merge_unpublished_award_criterion_description_lotsgroup_bt540(release_json, unpublished_award_criterion_description_data):
    """
