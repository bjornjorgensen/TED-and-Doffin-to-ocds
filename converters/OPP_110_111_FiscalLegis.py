...
def parse_fiscal_legislation(xml_content):
    ...
    lot_fiscal_docs = root.xpath("//cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:FiscalLegislationDocumentReference", namespaces=namespaces)
    ...
    part_fiscal_docs = root.xpath("//cac:ProcurementProjectLot[cbc:ID/@schemeName='Part']/cac:TenderingTerms/cac:FiscalLegislationDocumentReference", namespaces=namespaces)
...
def merge_fiscal_legislation(release_json, fiscal_legislation_data):
    ...
    logger.info(f"Merged Fiscal Legislation data for {len(fiscal_legislation_data['tender']['documents'])} documents")