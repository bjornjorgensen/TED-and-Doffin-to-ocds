    ...
    for organization in organizations:
        ...
        if org_id:
            ...
            for ubo in ubos:
                ...
                country_subentity_code = ubo.xpath("cac:ResidenceAddress/cbc:CountrySubentityCode[@listName='nuts']/text()", namespaces=namespaces)
...
def merge_ubo_country_subdivision(release_json, ubo_country_subdivision_data):
    ...
    logger.info(f"Merged UBO country subdivision data for {len(ubo_country_subdivision_data['parties'])} parties")