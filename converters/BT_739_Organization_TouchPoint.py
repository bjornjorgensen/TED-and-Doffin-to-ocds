...
def parse_touchpoint_contact_fax(xml_content):
    ...
    for organization in organizations:
        ...
        if touchpoint:
            ...
            fax_number = touchpoint[0].xpath("cac:Contact/cbc:Telefax/text()", namespaces=namespaces)
...
def merge_touchpoint_contact_fax(release_json, touchpoint_fax_data):
    ...
    logger.info(f"Merged touchpoint contact fax data for {len(touchpoint_fax_data['parties'])} touchpoints")