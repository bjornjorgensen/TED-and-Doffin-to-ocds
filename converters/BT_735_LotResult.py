...
def parse_cvd_contract_type_lotresult(xml_content):
    ...
    for lot_result in lot_results:
        ...
        cvd_code = lot_result.xpath(".//efac:StrategicProcurementInformation/efbc:ProcurementCategoryCode[@listName='cvd-contract-type']/text()", namespaces=namespaces)
            ...
            award_data = {
                ...
                "items": [{
                    ...
                    "additionalClassifications": [{
                        ...
                        "description": CVD_CONTRACT_TYPE_LABELS.get(cvd_code, "Unknown CVD contract type")
                    }]
                }]
            }
...
def merge_cvd_contract_type_lotresult(release_json, cvd_contract_type_data):
    ...
    for new_award in cvd_contract_type_data["awards"]:
        ...
        if existing_award:
            ...
            if existing_items:
                ...
                new_classification = new_award["items"][0]["additionalClassifications"][0]
                existing_classification = next((c for c in existing_classifications if c["scheme"] == "eu-cvd-contract-type"), None)
    ...
    logger.info(f"Merged CVD contract type data for {len(cvd_contract_type_data['awards'])} LotResults")