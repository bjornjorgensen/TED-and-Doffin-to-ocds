...
def parse_unpublished_procedure_type(xml_content):
    ...
    fields_privacy = root.xpath("//cac:TenderingProcess//ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='pro-typ']", namespaces=namespaces)
