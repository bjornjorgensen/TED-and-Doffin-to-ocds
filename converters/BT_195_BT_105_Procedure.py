...
def parse_bt195_bt105_unpublished_identifier(xml_content):
    ...
    field_identifier = root.xpath("//efac:FieldsPrivacy/efbc:FieldIdentifierCode[text()='pro-typ']/text()", namespaces=namespaces)
...
def merge_bt195_bt105_unpublished_identifier(release_json, unpublished_identifier_data):
    """
