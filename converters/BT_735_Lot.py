...
def parse_cvd_contract_type(xml_content):
    ...
    for lot in lots:
        ...
        cvd_code = lot.xpath(".//efac:StrategicProcurementInformation/efbc:ProcurementCategoryCode[@listName='cvd-contract-type']/text()", namespaces=namespaces)
...
def merge_cvd_contract_type(release_json, cvd_contract_type_data):
    ...
    logger.info(f"Merged CVD contract type data for {len(cvd_contract_type_data['tender']['lots'])} lots")