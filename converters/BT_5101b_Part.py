...
def parse_part_place_performance_streetline1(xml_content):
...
def merge_part_place_performance_streetline1(release_json, part_place_performance_streetline1_data):
    ...
    for new_address in part_place_performance_streetline1_data["tender"]["deliveryAddresses"]:
