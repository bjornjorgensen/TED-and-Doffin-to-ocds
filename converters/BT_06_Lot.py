...
def parse_strategic_procurement(xml_content):
    ...
    for lot in lots:
        ...
        procurement_types = lot.xpath(".//cac:ProcurementAdditionalType[cbc:ProcurementTypeCode/@listName='strategic-procurement']/cbc:ProcurementTypeCode/text()", namespaces=namespaces)
...
def merge_strategic_procurement(release_json, strategic_procurement_data):
    ...
    logger.info(f"Merged Strategic Procurement data for {len(strategic_procurement_data['tender']['lots'])} lots")