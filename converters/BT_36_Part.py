...
def parse_part_duration(xml_content):
    ...
    duration_measure = root.xpath("//cac:ProcurementProjectLot[cbc:ID/@schemeName='Part']/cac:ProcurementProject/cac:PlannedPeriod/cbc:DurationMeasure", namespaces=namespaces)
...
def merge_part_duration(release_json, part_duration_data):
    ...
    release_json.setdefault("tender", {}).setdefault("contractPeriod", {}).update(part_duration_data["tender"]["contractPeriod"])
