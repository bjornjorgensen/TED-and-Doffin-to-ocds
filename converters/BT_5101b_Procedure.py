...
def merge_procedure_place_performance_streetline1(release_json, procedure_place_performance_streetline1_data):
    ...
    for new_address in procedure_place_performance_streetline1_data["tender"]["deliveryAddresses"]:
