...
def parse_concession_revenue_user(xml_content):
    ...
    for lot_tender in lot_tenders:
        ...
        revenue_user = lot_tender.xpath("efac:ConcessionRevenue/efbc:RevenueUserAmount/text()", namespaces=namespaces)
        currency = lot_tender.xpath("efac:ConcessionRevenue/efbc:RevenueUserAmount/@currencyID", namespaces=namespaces)
...
def merge_concession_revenue_user(release_json, concession_revenue_user_data):
    ...
    logger.info(f"Merged Concession Revenue User data for {len(concession_revenue_user_data['contracts'])} contracts")