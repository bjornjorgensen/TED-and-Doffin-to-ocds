...
def BT_195_parse_unpublished_award_criterion_number_weight_lot_bt5421(xml_content):
    """
    Parse the XML content to extract the unpublished award criterion number weight for lots (BT-195, BT-5421).
...
def BT_195_merge_unpublished_award_criterion_number_weight_lot_bt5421(release_json, unpublished_award_criterion_number_weight_data):
    """
