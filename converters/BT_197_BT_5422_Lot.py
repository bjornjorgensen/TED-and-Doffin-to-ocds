# converters/BT_197_BT_5422_Lot.py
...
def parse_bt_197_bt_5422_lot(xml_content):
...
def merge_bt_197_bt_5422_lot(release_json, bt_197_bt_5422_data):
    if not bt_197_bt_5422_data:
        logger.warning("No BT-197(BT-5422)-Lot data to merge")
        return
    ...
    for withheld_item in release_json['withheldInformation']:
        if withheld_item.get('id') == "BT-195(BT-5422)-Lot":
