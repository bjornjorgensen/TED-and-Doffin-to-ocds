...
def parse_framework_maximum_value(xml_content):
    ...
    for lot_result in lot_results:
        ...
        max_value = lot_result.xpath("efac:FrameworkAgreementValues/cbc:MaximumValueAmount/text()", namespaces=namespaces)
...
def merge_framework_maximum_value(release_json, framework_max_value_data):
    ...
    logger.info(f"Merged framework maximum value data for {len(framework_max_value_data['awards'])} awards")