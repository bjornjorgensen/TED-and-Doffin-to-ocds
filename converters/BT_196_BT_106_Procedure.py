...
def parse_bt196_bt106_unpublished_justification(xml_content):
    """
    Parse the XML content to extract the unpublished justification description for the accelerated procedure.
    ...
    reason_description = root.xpath("//cac:TenderingProcess/cac:ProcessJustification[cbc:ProcessReasonCode/@listName='accelerated-procedure']/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='pro-acc']/efbc:ReasonDescription/text()", namespaces=namespaces)
...
def merge_bt196_bt106_unpublished_justification(release_json, unpublished_justification_data):
    """
