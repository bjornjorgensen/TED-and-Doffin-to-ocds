...
def parse_touchpoint_website(xml_content):
    ...
    for organization in organizations:
        ...
        website_uri = organization.xpath("efac:TouchPoint/cbc:WebsiteURI/text()", namespaces=namespaces)
...
def merge_touchpoint_website(release_json, touchpoint_website_data):
    ...
    logger.info(f"Merged TouchPoint Website data for {len(touchpoint_website_data['parties'])} parties")