...
def parse_employment_legislation(xml_content):
    ...
    lot_employ_docs = root.xpath("//cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:EmploymentLegislationDocumentReference", namespaces=namespaces)
    ...
    part_employ_docs = root.xpath("//cac:ProcurementProjectLot[cbc:ID/@schemeName='Part']/cac:TenderingTerms/cac:EmploymentLegislationDocumentReference", namespaces=namespaces)
...
def merge_employment_legislation(release_json, employment_legislation_data):
    ...
    logger.info(f"Merged Employment Legislation data for {len(employment_legislation_data['tender']['documents'])} documents")