...
def parse_organization_part_name(xml_content):
    ...
    for organization in organizations:
        ...
        org_name = organization.xpath("efac:Company/cac:PartyName/cbc:Name/text()", namespaces=namespaces)
        department = organization.xpath("efac:Company/cac:PostalAddress/cbc:Department/text()", namespaces=namespaces)
...
def merge_organization_part_name(release_json, organization_part_name_data):
    ...
    logger.info(f"Merged Organization Part Name data for {len(organization_part_name_data['parties'])} parties")