...
def parse_lot_public_opening_date(xml_content):
    ...
    for lot_element in lot_elements:
        ...
        date = lot_element.xpath("cac:TenderingProcess/cac:OpenTenderEvent/cbc:OccurrenceDate/text()", namespaces=namespaces)
        time = lot_element.xpath("cac:TenderingProcess/cac:OpenTenderEvent/cbc:OccurrenceTime/text()", namespaces=namespaces)
