...
def parse_vehicle_numeric(xml_content):
    ...
    for lot_result in lot_results:
        ...
        for stat in statistics:
            ...
            numeric = int(stat.xpath("efbc:StatisticsNumeric/text()", namespaces=namespaces)[0])
...
def merge_vehicle_numeric(release_json, vehicle_numeric_data):
    ...
    logger.info(f"Merged vehicle numeric data for {len(vehicle_numeric_data['awards'])} awards")