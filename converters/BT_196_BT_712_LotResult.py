...
def parse_bt_196_bt_712_lot_result(xml_content):
    ...
    for lot_result in lot_results:
        ...
        fields_privacy = lot_result.xpath(
            "./efac:AppealRequestsStatistics[efbc:StatisticsCode/@listName='review-type']/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='rev-req']",
...
def merge_bt_196_bt_712_lot_result(release_json, bt_196_data):
    if not bt_196_data:
        return
