...
def parse_organization_contact_email(xml_content):
    ...
    for organization in organizations:
        ...
        contact_email = organization.xpath("efac:Company/cac:Contact/cbc:ElectronicMail/text()", namespaces=namespaces)
...
def merge_organization_contact_email(release_json, organization_contact_email_data):
    ...
    logger.info(f"Merged Organization Contact Email data for {len(organization_contact_email_data['parties'])} parties")