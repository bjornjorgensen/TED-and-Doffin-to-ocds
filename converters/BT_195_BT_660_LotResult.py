...
def parse_unpublished_framework_reestimated_value_lotresult_bt660(xml_content):
    ...
    xpath = "/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeResult/efac:LotResult/efac:FrameworkAgreementValues/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='ree-val']"
...
def merge_unpublished_framework_reestimated_value_lotresult_bt660(release_json, withheld_info_data):
