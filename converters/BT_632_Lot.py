...
def parse_tool_name(xml_content):
    ...
    for lot in lots:
        ...
        tool_name = lot.xpath("cac:TenderingProcess/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efbc:AccessToolName/text()", namespaces=namespaces)
...
def merge_tool_name(release_json, tool_name_data):
    ...
    logger.info(f"Merged tool name data for {len(tool_name_data['tender']['lots'])} lots")