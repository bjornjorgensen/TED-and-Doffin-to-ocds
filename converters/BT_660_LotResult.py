...
def parse_framework_reestimated_value(xml_content):
    ...
    for lot_result in lot_results:
        ...
        reestimated_value = lot_result.xpath("efac:FrameworkAgreementValues/efbc:ReestimatedValueAmount/text()", namespaces=namespaces)
        currency = lot_result.xpath("efac:FrameworkAgreementValues/efbc:ReestimatedValueAmount/@currencyID", namespaces=namespaces)
        related_lot = lot_result.xpath("efac:TenderLot/cbc:ID[@schemeName='Lot']/text()", namespaces=namespaces)
...
def merge_framework_reestimated_value(release_json, framework_reestimated_value_data):
    ...
    logger.info(f"Merged Framework Re-estimated Value data for {len(framework_reestimated_value_data['awards'])} awards")