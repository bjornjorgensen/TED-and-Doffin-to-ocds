...
def parse_organization_contact_point(xml_content):
    ...
    for organization in organizations:
        ...
        contact_name = organization.xpath("efac:Company/cac:Contact/cbc:Name/text()", namespaces=namespaces)
...
def merge_organization_contact_point(release_json, organization_contact_point_data):
    ...
    logger.info(f"Merged Organization Contact Point data for {len(organization_contact_point_data['parties'])} parties")