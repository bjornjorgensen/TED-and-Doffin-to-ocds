...
def parse_organization_contact_telephone(xml_content):
    ...
    for organization in organizations:
        ...
        contact_telephone = organization.xpath("efac:Company/cac:Contact/cbc:Telephone/text()", namespaces=namespaces)
        
        if org_id and contact_telephone:
            party = {
                "id": org_id[0],
                "contactPoint": {
                    "telephone": contact_telephone[0]
                }
            }
...
def merge_organization_contact_telephone(release_json, organization_contact_telephone_data):
    ...
    for new_party in organization_contact_telephone_data["parties"]:
    ...
    logger.info(f"Merged Organization Contact Telephone data for {len(organization_contact_telephone_data['parties'])} parties")