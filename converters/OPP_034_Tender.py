    ...
    for lot_tender in lot_tenders:
        ...
        if tender_id:
            ...
            if lot_result:
                ...
                if lot_id:
                    penalties = lot_tender.xpath("efac:ContractTerm/efac:FinancialPerformanceRequirement[efbc:FinancialPerformanceTypeCode='penalty']/efbc:FinancialPerformanceDescription/text()", namespaces=namespaces)
                    rewards = lot_tender.xpath("efac:ContractTerm/efac:FinancialPerformanceRequirement[efbc:FinancialPerformanceTypeCode='reward']/efbc:FinancialPerformanceDescription/text()", namespaces=namespaces)
