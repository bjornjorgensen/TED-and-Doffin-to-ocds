...
def BT_198_parse_unpublished_access_date_BT_09_Procedure(xml_content):
    ...
    publication_date = root.xpath("//cac:TenderingTerms/cac:ProcurementLegislationDocumentReference[cbc:ID/text()='CrossBorderLaw']/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:FieldsPrivacy[efbc:FieldIdentifierCode/text()='cro-bor-law']/efbc:PublicationDate/text()", namespaces=namespaces)
...
def BT_198_merge_unpublished_access_date_BT_09_Procedure(release_json, unpublished_access_date_data):
    """
