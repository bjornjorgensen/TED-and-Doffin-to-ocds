# converters/BT_197_BT_5421_Lot.py
...
def parse_bt_197_bt_5421_lot(xml_content):
...
def merge_bt_197_bt_5421_lot(release_json, bt_197_bt_5421_data):
    if not bt_197_bt_5421_data:
        logger.warning("No BT-197(BT-5421)-Lot data to merge")
        return
    ...
    for withheld_item in release_json['withheldInformation']:
        if withheld_item.get('id') == "BT-195(BT-5421)-Lot":
